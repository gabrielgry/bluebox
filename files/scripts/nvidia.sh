...
BASE_IMAGE_NAME="silverblue" UBLUE_IMAGE_TAG="42" RPMFUSION_MIRROR="" AKMODS_FLAVOR="main" KERNEL="6.14.6-300.fc42.x86_64" IMAGE_NAME="silverblue-nvidia" /tmp/install-kernel-akmods.sh
